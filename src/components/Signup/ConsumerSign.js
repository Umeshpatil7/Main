...
import $ from "jquery";
import Con from "../images/consumer.jpg"

function ConsumerSign()
{
    ...
    <div className="container">
        ...
        <div className="signup-content">
            ...
            <div className="signup-form">
                ...
                <form method="POST" className="register-form" id="regForm">
                    ...
                    <div className="form-group">
                        ...
                        <input type="text" name="name" id="name" value={company!==""?company:""} placeholder="Name" onInput={(e)=>{setCompany(e.target.value)}} required/>
                    </div>
                    <div className="form-group">
                    ...
                    <div className="form-group">
                        ...
                        <input type="text" name="address" id="address" value={add!==""?add:""} placeholder="Address" onInput={(e)=>{setAdd(e.target.value)}} required />
                    </div>
                    <div className="form-group">
            ...
            <div className="signup-image">
                <div>
                <figure><img src={Con} alt="sign up image" height="100px"/></figure>
                </div>
            </div>
