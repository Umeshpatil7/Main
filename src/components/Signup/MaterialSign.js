        ...
        <div className="signup-content">
            ...
            <div className="signup-form">
                ...
                <form method="POST" className="register-form" id="regForm">
                    ...
                    <div className="form-group">
                        <label htmlFor=" WareHouse Address"><FontAwesomeIcon icon={faImage}/>Uplode Aadhar Card</label><br /><br /><br />
                        <input type="file" name="aadhar" id="aadhar" value={add!==""?add:""} placeholder="Uplode Aadhar" onInput={(e)=>{setAdd(e.target.value)}} required />
                    </div>
                    <div className="form-group">
                        <label htmlFor=" WareHouse Address"><FontAwesomeIcon icon={faHome}/></label>
                        <input type="text" name="address" id="address" value={add!==""?add:""} placeholder="Company Address" onInput={(e)=>{setAdd(e.target.value)}} required />
                    </div>
                    <div className="form-group">
                    ...
                    <div className="form-group">
                        ...
                        <input list="states" name="state" placeholder="State" value={state!=""?state:""}/>
                             <datalist id="states">
                    ...
                    <div className="form-group">
                      ...
                      <input type="Number" className="form-control"  name="user_mob_no" required placeholder="Pincode"  pattern="/^-?\d+\.?\d*$/" onKeyPress={(e)=>{handleCompanyRegister(e)}} />
                    </div>
                    <div className="form-group">
                      <label><FontAwesomeIcon icon={faBook}/></label>
                      <input type="Number" className="form-control"  name="user_mob_no" required placeholder="Landmark"  pattern="/^-?\d+\.?\d*$/" onKeyPress={(e)=>{handleCompanyRegister(e)}} />
                    </div>
                    ...
                    <div className="form-group">
                        ...
                        <input type="text" name="user" id="user" value={user!==""?user:""} placeholder="Username" required />
                    </div>
                    <div className="form-group">
                      <label htmlFor="pass"><FontAwesomeIcon icon={faLock}/></label>
                      Password: <input type="password" value="" id="myInput" placeholder="Password"/> 
                  </div>
                  <div className="form-group">
            ...
            <div className="signup-image">
                <div>
                {/* <figure><img src={mat} alt="sign up image" height="100px"/></figure> */}
                </div>
            </div>
