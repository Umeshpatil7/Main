        ...
        <div className="signup-content">
            ...
            <div className="signup-form">
                ...
                <form method="POST" className="register-form" id="regForm">
                    ...
                    <div className="form-group">
                        <label htmlFor=" WareHouse Address"><FontAwesomeIcon icon={faImage}/>Uplode Aadhar Card</label>
                    ...
                    <div className="form-group">
                      <label><FontAwesomeIcon icon={faBook}/></label>
                      <input type="Text" className="form-control"  name="user_mob_no" required placeholder="Landmark"  pattern="/^-?\d+\.?\d*$/" onKeyPress={(e)=>{handleCompanyRegister(e)}} />
                    </div>
                    <div className="form-group">
                      <label><FontAwesomeIcon icon={faBook}/></label>
            ...
            <div className="signup-image">
                <div>
                <figure><img src={manu} alt="sign up image" height="100px"/></figure>
                </div>
            </div>
...
export default ManufacturerSign;