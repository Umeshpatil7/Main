    ...
    <div className="container">
        ...
        <div className="signup-content">
            ...
            <div className="signup-form">
                ...
                <form method="POST" className="register-form" id="regForm">
                    ...
                    <div className="form-group">
                        ...
                        <input type="text" name="name" id="name" value={company!==""?company:""} placeholder="Your Name" onInput={(e)=>{setCompany(e.target.value)}} required/>
                    </div>
                    <div className="form-group">
                    ...
                    <div className="form-group">
                      ...
                      <input type="Number" className="form-control"  name="user_adhar" required placeholder="Aadhar Number"  pattern="/^-?\d+\.?\d*$/" onKeyPress={(e)=>{handleCompanyRegister(e)}} />
                    </div>
            ...
            <div className="signup-image">
                <div>
                <figure><img src={farm} alt="sign up image" height="100px"/></figure>
                </div>
